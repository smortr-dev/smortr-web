...
export default async function Profile() {
  ...
  return (
    <>
      <div className="relative cursor-pointe h-[100vh]">
        <div className="overflow-clip h-[40%]">
          <img
            src={`${profileData.userInfo.background}`}
        ...
        <div className="flex justify-center p-4  items-center absolute bg-white min-h-[15%] rounded-[6px] w-[30%]  left-[35%] lg:translate-y-[calc(-85%-7.8rem)] translate-y-[calc(-85%-5rem)] shadow-[0_10px_50px_rgba(0,0,0,0.25)]">
          <div className="absolute bottom-2 right-4 text-[0.6rem] font-[500] text-[#848484]">
            {new Date(profileData.userInfo.thoughtPostDate).toLocaleString()}
          </div>
          <div className=" md:text-[1rem] font-[400] tracking-[-0.015rem]">
            {profileData.userInfo.thought}
          </div>
        </div>
            ...
            <div className="">
              ...
              <div className="flex justify-center last:pr-0 mt-4">
                <div className="inline-block pr-4">
                  ...
                  <span className="text-[0.8rem] text-[#848484]">
                    {" "}
                    {profileData.userInfo.connections}
                  </span>
                </div>
                <div className="inline-block pr-4">
                  <img
              ...
              <div className="text-[0.8rem] text-[#848484] text-center mb-4">
                ...
                <span className="font-[700]">
                  {profileData.userInfo.workPreference}
                </span>
              </div>
            </div>
          </div>
      ...
      <div className="flex justify-center py-12">
        <Button className=" p-4 bg-[#1B1B2D] leading-5 text-white border-2 border-transparent rounded-[6px] hover:text-[#1B1B2D] hover:bg-white hover:border-[#1B1B2D]">
          View Profile
        </Button>
      </div>
      <div className="px-16 pt-8 mb-4">
          ...
          {profileData.education.map((education, index) => {
            return (
              <>
                ...
                >
                  <div
                    className={`h-[35vh] rounded-t-[18px] z-[8] border-[0.06rem] border-black w-full  bg-[#FAFAFA]  hover:cursor-move overflow-clip`}
                    // onClick={() => {}}
                  >
                    <img
                      src={`bg1.png`}
                      alt="preview"
                      className="block object-cover h-full z-[12] w-full cursor:pointer"
                    />
                  </div>
      ...
      <div className="px-16 pt-8 mb-4">
        <h3 className="text-[1.3rem] px-2 font-[700]">Certification/License</h3>
