...
//                 <DialogTrigger className="relative z-[5] 2k:mt-6 lg:mt-4 md:mt-4 mt-8 block w-[100%]  bg-black float-right text-white border-2 border-transparent rounded-[6px] hover:text-black hover:bg-white hover:border-black tracking-tight text-[0.875rem] py-2">
//                   Sign up now!
//                 </DialogTrigger>
//                 <DialogContent>
//                   <Form
...
//       <HubspotProvider>
//         <Dialog open={open} onOpenChange={setOpen}>
//           <DialogTrigger className="relative z-[5] 2k:mt-6 lg:mt-4 md:mt-4 mt-8 block w-[100%]  bg-black float-right text-white border-2 border-transparent rounded-[6px] hover:text-black hover:bg-white hover:border-black">
//             Open
//           </DialogTrigger>
//           <DialogContent>
//             <Form
...
//           <HubspotProvider>
//             <Dialog open={open} onOpenChange={setOpen}>
//               <DialogTrigger className="relative w-[70vw] hd:w-[40vw] uhd:w-[25vw] z-[5] lg:mt-8 md:mt-4 mt-8 block  bg-black float-right text-white border-2 border-transparent rounded-[6px] hover:text-black hover:bg-white hover:border-black py-2">
//                 Join Waitlist
//               </DialogTrigger>
//               <DialogContent>
//                 <Form
