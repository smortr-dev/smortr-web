  ...
  return (
    <>
      <div
        ...
        // key={index}
        className="hover:translate-y-[-1rem] transition-transform relative min-h-[30vw] hover:cursor-pointer shadow-[0_3px_50px_0px_rgba(0,0,0,0.1)] py-4 rounded-[1.13rem]"
      >
        <div className="text-[0.9rem] font-[700] px-4 py-8 text-left w-full">
          {cardData.question}
        </div>
        <div className="md:h-[20vw] h-[30vh] border-2 border-black w-full">
          <img
        ...
        <div className="flex justify-center items-center">
          <div className="text-[1rem] px-4 pt-3 text-left w-full">
            {cardData.caption}
          </div>
        </div>
