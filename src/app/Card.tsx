...
export default function Card(props: CardProps) {
  return (
    <>
      <div>
        {/* <Link className="inline-block" href={props.link} target="_blank"> */}
        <div
          className="relative cursor-pointer lg:w-[25vw] md:w-[40vw] w-[70vw]  rounded-[18px] lg:h-[70vh] md:h-[45vh] h-[55vh] bg-white "
          onClick={() => {
