...
export default function Card(props: CardProps) {
  return (
    <div className="h-full">
      <div className="overflow-clip relative w-[70vw] h-full tab:w-[40vw] hd:w-[28vw] uhd:w-[20vw] 2k:w-[20vw] 4k:w-[20vw] rounded-[18px] bg-white uhd:hover:translate-y-[-1rem] transition-custom border-[#1B1B2D] border-[4px] uhd:border-[6px] hover:border-[#D1D1D1]">
        ...
        <div className="flex justify-center md:p-[0.65rem]  p-[0.5rem] items-center absolute bg-white min-h-[15%] rounded-[6px]  md:w-[90%] w-[90%] md:left-[calc(5%)] left-[calc(5%)] translate-y-[calc(-100%-3.3rem)] lg:translate-y-[calc(-100%-2.8rem)] shadow-[0_10px_50px_rgba(0,0,0,0.25)]">
        ...
        <img
          ...
          alt="img"
        />
        <div className="hd:px-3 px-3 pb-3 flex flex-col hd:justify-left ">
          ...
          <div className="block uhd:hidden absolute text-center bottom-[0.7rem] left-[50%] translate-x-[-50%] ">
            <Button className="py-0 text-[0.7rem] h-[1.75rem] leading-3 inline-block bg-black text-white border-2 border-transparent rounded-[6px] hover:text-black hover:bg-white hover:border-black">
              Visit Profile
            </Button>
          </div>
        </div>
        <div className="absolute uhd:block hidden h-full card-hover w-full top-0 rounded-[18px] text-center group">
          <Button className=" hidden uhd:group-hover:inline-block absolute bottom-6 whitespace-nowrap hd:h-auto py-1 hd:text-[0.7rem] bg-black text-white border-2 border-transparent rounded-[6px] hover:text-black hover:bg-white hover:border-black left-[50%] translate-x-[-50%]">
            Visit Profile
          </Button>
        </div>
      </div>
